...
const SETTINGS_ENCRYPTION_KEY =
  process.env.NEXT_PUBLIC_SETTINGS_ENCRYPTION_KEY ?? process.env.NEXT_PUBLIC_PROFILE_ENCRYPTION_KEY;
    ...
    return {
      ...
      settings: {
        ...
        accountManagementUrl:
          payload.accountManagementUrl === undefined
            ? DEFAULT_SETTINGS.accountManagementUrl
            : payload.accountManagementUrl,
      },
